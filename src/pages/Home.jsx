    ...
    <div className="bg-black text-white">
          ...
          <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-8 text-sm text-zinc-400">
              ...
              <button
                ...
                className="text-white border border-white/10 px-4 py-1.5 rounded-md hover:bg-white hover:text-black"
              >
                Get Started
              </button>
            </div>
      ...
      <section className="relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 py-32 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="aspect-[4/3] rounded-2xl border border-white/[0.08] bg-white/[0.02] backdrop-blur-xl overflow-hidden">
              {/* TOPBAR */}
              <div className="h-14 border-b border-white/[0.06] bg-black/40 flex items-center justify-between px-5">
                ...
                <div className="text-xs text-zinc-500 tracking-wide">
                  Cognitive Canvas Workspace
                </div>
              </div>

              {/* BODY */}
              <div className="grid grid-cols-[72px_1fr] h-[calc(100%-56px)]">
                {/* SIDEBAR */}
                <div className="border-r border-white/[0.06] bg-black/30 flex flex-col items-center py-5 gap-4">
                  <div className="w-10 h-10 rounded-xl bg-white text-black flex items-center justify-center font-semibold">
                    ✦
                  </div>

                  <div className="w-10 h-10 rounded-xl border border-white/[0.08] bg-white/[0.02]" />
                  <div className="w-10 h-10 rounded-xl border border-white/[0.08] bg-white/[0.02]" />
                  <div className="w-10 h-10 rounded-xl border border-white/[0.08] bg-white/[0.02]" />
                </div>
                ...
                <div className="flex flex-col">
                  {/* HEADER */}
                  <div className="h-16 border-b border-white/[0.06] px-5 flex items-center justify-between">
                    <div>
                  ...
                  <div className="flex-1 p-5 bg-black/20">
                    <div className="w-full h-full rounded-xl border border-dashed border-white/[0.08] bg-black/20 relative overflow-hidden">
                      {/* FLOATING BLOCKS */}
                      <div className="absolute top-8 left-8 w-40 h-20 rounded-xl border border-white/[0.08] bg-white/[0.03] backdrop-blur-md" />

                      <div className="absolute top-32 right-12 w-48 h-24 rounded-xl border border-white/[0.08] bg-white/[0.03] backdrop-blur-md" />

                      <div className="absolute bottom-10 left-1/2 -translate-x-1/2 w-56 h-28 rounded-xl border border-white/[0.08] bg-white/[0.03] backdrop-blur-md" />

                      {/* CONNECTION LINES */}
                      <div className="absolute top-[120px] left-[180px] w-32 h-px bg-white/[0.08]" />

                      <div className="absolute top-[210px] left-[320px] w-40 h-px bg-white/[0.08]" />
      ...
      >
        <div className="max-w-4xl mx-auto px-6 py-32 text-center">
          ...
          <button
            ...
            className="mt-12 bg-white text-black px-10 py-3 rounded-md font-medium hover:bg-zinc-200 transition"
          >
            Get Started
          </button>
        </div>
